...
open class SearchTextField: UITextField {
    ...
    fileprivate func buildPlaceholderLabel() {
        ...
        if let placeholderLabel = placeholderLabel {
            ...
            if let placeholderColor = self.attributedPlaceholder?.attribute(NSForegroundColorAttributeName, at: 0, effectiveRange: nil) as? UIColor {                placeholderLabel?.textColor = placeholderColor
            } else {
